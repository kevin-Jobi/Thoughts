...
import 'package:thoughts/presentation/widget/custom_text_field.dart';
import 'package:thoughts/theme/app_theme.dart';
import 'package:thoughts/view_models/login_view_model.dart';
        ...
        child: Consumer<LoginViewModel>(
          builder: (context, viewModel, _) {
              ...
              WidgetsBinding.instance.addPostFrameCallback((_) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    ...
                    margin: const EdgeInsets.all(16),
                    duration: const Duration(seconds: 3),
                    onVisible: () => viewModel.clearErrorMessage(),
                  ),
                );
              });
            }
            ...
            if (viewModel.resetPasswordSuccess &&
                viewModel.resetPasswordMessage != null) {
              WidgetsBinding.instance.addPostFrameCallback((_) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(viewModel.resetPasswordMessage!),
                    backgroundColor: AppColors.success,
                    behavior: SnackBarBehavior.floating,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10),
                    ...
                    margin: const EdgeInsets.all(16),
                    duration: const Duration(seconds: 3),
                    onVisible: () => viewModel.clearResetPasswordSuccess(),
                  ),
                );
              });
            }

            if (viewModel.resetPasswordInitiated &&
                !viewModel.resetPasswordInitiatedShown) {
              WidgetsBinding.instance.addPostFrameCallback((_) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: const Text('Sending password reset email...'),
                    ...
                    duration: const Duration(seconds: 2),
                    onVisible: () =>
                        viewModel.markResetPasswordInitiatedShown(),
                  ),
                );
              });
            }
                                ...
                                Align(
                                  ...
                                  child: GestureDetector(
                                    onTap:
                                        ...
                                        ? null
                                        : () {
                                            viewModel.initiateResetPassword();
